...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Comments for Columns';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='SQL history';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pma_pdf_pages` (
  ...
  PRIMARY KEY (`page_nr`),
  KEY `db_name` (`db_name`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='PDF Relationpages for PMA';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Table coordinates for phpMyAdmin\n            PDF output';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pma_table_info` (
  ...
  PRIMARY KEY (`db_name`,`table_name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Table    information    for\n            phpMyAdmin';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pma_userconfig` VALUES ('root','2013-12-11 23:16:36','{\"lang\":\"es\"}'),('administrator','2013-12-14 00:21:36','[]');
...
-- Dump completed on 2013-12-16 17:50:53
