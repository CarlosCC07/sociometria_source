	...
	function analisisGlobal(){
		...
		try {
			...
			for($i=0;$i<$total;$i++){
				...
				echo"<tr class=\"per".$info[$i]->extra."\" onclick=\"\" ><td style=\"text-align:right;\">".$i+1."</td><td style=\"text-align:right;\">".$info[$i]->idTrabajador."</td><td style=\"text-align:center;\">";
